...
<input class="btn btn-inverse btn-block btn-large" type=submit value="Reset password">
</form>
<form action="DeleteAccount" method="get">
<input class="btn btn-inverse btn-block  btn-large" type=submit value="Delete Account">
</form>
 </div>
